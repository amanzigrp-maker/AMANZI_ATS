...
export const setupSecurityMiddleware = (app: Express) => {
  ...
  app.use((req: Request, res: Response, next: NextFunction) => {
    ...
    if (!origin) {
      ...
      (corsOptions.origin as any)(origin, (err: any, allow: any) => {
        corsError = err;
 ...
 */
export const validateAuthHeader = (req: Request): string | null => {
 ...
 */
export const isTrustedSource = (req: Request): boolean => {
