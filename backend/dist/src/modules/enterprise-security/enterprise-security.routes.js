...
const verifyUserOrIngestToken = (req, res, next) => {
...
router.post("/events", verifyUserOrIngestToken, async (req, res) => {
...
router.post("/offline-cache/sync", verifyUserOrIngestToken, async (req, res) => {
