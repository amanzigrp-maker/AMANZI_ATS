...
export class HeartbeatService {
     ...
     */
    static async recordHeartbeat(sessionId, candidateId, payload) {
        ...
        await pool.query("UPDATE exam_snapshots SET last_heartbeat_at = CURRENT_TIMESTAMP WHERE session_id = $1", [sessionId]);
     ...
     */
    static async detectMissingHeartbeats() {
        try {
