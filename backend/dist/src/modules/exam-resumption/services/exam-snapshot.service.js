...
export class ExamSnapshotService {
    ...
    static async loadSnapshot(sessionId) {
        ...
        if (cached) {
            ...
            console.warn(`[ExamSnapshotService] Cache integrity failure for session ${sessionId}`);
        }
        // PostgreSQL fallback
    ...
    static async computeRemainingTime(sessionId) {
        ...
        const totalSeconds = (duration_mins || 30) * 60;
    ...
    static async validateSnapshotIntegrity(snapshot) {
        ...
        const isValidTime = snapshot.time_remaining_seconds <=
