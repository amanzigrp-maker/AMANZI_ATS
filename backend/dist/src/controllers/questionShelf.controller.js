...
export class QuestionShelfController {
     ...
     */
    static async listShelves(req, res) {
        try {
     ...
     */
    static async getShelfDetail(req, res) {
        try {
     ...
     */
    static async addQuestionToShelf(req, res) {
        try {
            const category = String(req.params.category || "");
            ...
            const result = await QuestionShelfService.saveQuestionToShelf(questionObj, topic || category, "Manual Entry");
            if (result) {
     ...
     */
    static async deleteQuestionFromShelf(req, res) {
        try {
            const category = String(req.params.category || "");
