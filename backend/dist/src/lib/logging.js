...
export const shouldShowSensitiveDevLogs = () => String(process.env.LOG_SENSITIVE_DEV_DETAILS || '').toLowerCase() === 'true';
...
export const maskSecret = (label) => `${label}: [redacted]`;
...
export const installConsoleFilters = () => {
    ...
    const wrap = (original, level) => (...args) => {
