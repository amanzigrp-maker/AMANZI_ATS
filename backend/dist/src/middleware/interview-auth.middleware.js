 ...
 */
export const authenticateInterviewUser = async (req, res, next) => {
    try {
        ...
        const result = await pool.query('SELECT id, email, interview_id, is_active, expires_at FROM interview_users WHERE id = $1', [decoded.interviewUserId]);
