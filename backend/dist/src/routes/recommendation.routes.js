...
import { searchTalentPool, getRecommendations, getRecommendationStats, updateRecommendationStatus, generateRecommendations, getRecommendationDetail, } from "../controllers/recommendation.controller";
const router = Router();
