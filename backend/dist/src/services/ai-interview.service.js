...
const looksTechnical = (role, skill, semanticContext) => {
    const combined = [
        role,
        skill,
...
const buildFallbackQuestion = (role, skill, difficulty) => {
...
export const generateAdaptiveQuestionAtDifficulty = async (role, experience, skill, difficulty, semanticContext = {}, options = {}) => {
    initAI();
 ...
 */
export const generateAdaptiveSequence = async (role, experience, skill, total_questions) => {
    initAI();
    const prompt = `
