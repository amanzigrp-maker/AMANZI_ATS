    ...
    async sendNotification(data) {
        try {
          ...
          sender_role, recipient_role, priority
            ...
            console.log(`📩 Notification sent → User ${data.userId} | Job Code: ${data.relatedJobCode || 'N/A'}`);
        }
        catch (error) {
    ...
    async sendBulkNotifications(notifications) {
        ...
        try {
            ...
            sender_role, recipient_role, priority
                ...
                console.log(`📩 Bulk Notification → User ${n.userId} | Job Code: ${n.relatedJobCode || 'N/A'}`);
            }
